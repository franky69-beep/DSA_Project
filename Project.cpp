...
int main() {
    ...
    while (true) {
        ...
        case 1: {
            ...
            cout << "Random numbers generated in " << duration.count() << " milliseconds.\n";
        ...
        case 2: {
            ...
            cout << "Quick Sort completed in " << duration.count() << " milliseconds.\n";
            cout << "Sorted Array:\n";
        ...
        case 3: {
            ...
            cout << "Merge Sort completed in " << duration.count() << " milliseconds.\n";
            cout << "Sorted Array:\n";
            displayArray(sortedList, size);
            break;
        }
